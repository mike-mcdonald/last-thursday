...
namespace Drupal\esri_geofield\Plugin\Field\FieldFormatter;

use Drupal\esri_geofield\EsriGeofieldMapTrait;
use Drupal\esri_geofield\EsriGeofieldZoomTrait;
...
class EsriGeofieldFormatter extends FormatterBase {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    $mapid = Html::getUniqueId("esri_geofield_map_{$bundle}_{$entity_id}_{$field->getName()}");

    $element = array(
      '#type' => 'esri_geofield_formatter',
      '#mapid' => $mapid,
      '#value' => $values,
      '#basemap' => 'streets-vector',
