...
namespace Drupal\esri_geofield\Plugin\Field\FieldWidget;

use Drupal\esri_geofield\EsriGeofieldMapTrait;
use Drupal\esri_geofield\EsriGeofieldZoomTrait;
use Drupal\esri_geofield\EsriGeofieldAddressTrait;
use Drupal\Core\Url;
...
/**
 * Plugin implementation of the 'esri_geofield' widget.
 *
 * @FieldWidget(
 *   id = "esri_geofield",
